...
//   // ✅ SAFE image resolver (string only now)
//   const getPreviewImage = () => {
//     if (!image) return null;
//     if (typeof image === "string") return image;
//     if (image instanceof File) {
//       return URL.createObjectURL(image); // preview new upload
//     }
//     return null;
//   };

//   // ✅ CORRECT handler (Base64)
//   const handleImageChange = (e) => {
//     const file = e.target.files[0];
//     if (!file) return;

//     setImage(file); // ✅ store File object ONLY
//   };
...
//             <div className="h-28 w-28 rounded-full bg-gray-100 border flex items-center justify-center overflow-hidden">
//               {getPreviewImage() ? (
//                 <img
//                   src={getPreviewImage()}
//                   alt="profile"
...
//               className="mt-1 w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-600 outline-none"
//             />
//           </div>
